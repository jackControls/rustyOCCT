...
unchanged pre-implementation capture. It checks byte-identical regeneration
of the native inputs and fixtures, and that the Rust probe's issue lists equal
