...
`TOPOLOGY_MODEL.md` adds the `brep_io` target (T2; T1 added the six
cell-complex mutations to `brep_validation`); `IDENTITY_AND_HISTORY.md` adds
`attributes` (M4) and enclosure mutations (M5); M3 added `split_merge`. A planned
