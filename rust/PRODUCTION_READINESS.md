...
bridge (44 matches, eight reviewed differences on macOS). Platform and
clean-revision acceptance are pending. See [B-rep validation](BREP_VALIDATION.md).
