...
| Fuzzing and differential geometry | Structured operation sequences, invalid input, minimized failures, independent oracles and original upstream tests | Five sanitizer/coverage-guided targets with daily campaigns and retained corpora, 66 OCCT prisms, 72 native line/plane cases, 174 polynomial/curved cases, 214 spline cases and three original DRAW cases; full algorithm coverage and a source-pinned runtime oracle pending |
