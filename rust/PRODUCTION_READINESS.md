...
| Fuzzing and differential geometry | Structured operation sequences, invalid input, minimized failures, independent oracles and original upstream tests | Nine sanitizer/coverage-guided targets with daily campaigns and retained corpora, 66 OCCT prisms, 72 native line/plane cases, 174 polynomial/curved cases, 456 curve, 210 surface, 214 spline/plane, 92 spline/quadric and 370 proximity cases (reviewed numerical differences/nonresults reported separately) and three original DRAW cases; full algorithm coverage and a source-pinned runtime oracle pending |
