...
| Stable topology history | Generated/modified/deleted face and edge mappings across kernel operations; explicit split/merge ambiguity | Only body-local IDs and extrusion provenance exist; contracts and milestones M0–M5 are specified in `IDENTITY_AND_HISTORY.md`; general operation history pending |
...
specifies them and their delivery milestones. Define operation
