...
| Numerical constructions | Error/residual bounds, conditioning, explicit degeneracy, tolerance propagation through projections/intersections | Exact degree-25 real roots, complete exact linear sets, certified analytic and spline/plane/sphere/cylinder intersections, rational spline curve/surface jets, exact curve/tensor-patch editing, curve/surface knot refinement/removal and exact edited-curve intersection results exist; general degree elevation, arbitrary face trimming, intersections and topology tolerance propagation pending |
